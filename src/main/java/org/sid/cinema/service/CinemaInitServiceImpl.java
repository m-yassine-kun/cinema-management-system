...
public class CinemaInitServiceImpl implements ICinemaInitService{
    ...
    public void initCategories() {
        Stream.of("Histore", "Actions", "Fiction", "Drama").forEach(cat->{
    ...
    public void initFilms() {
        ...
        Stream.of("12 Hommes en colaires","Forrest Gump", "Green Book", "La ligne verte", "le Parrain", "Le Seigneur des anneaux")
                .forEach(titreFilm->{
                    Film film = new Film();
